...
|----------|---------|---------|
| `/api/autors` | GET / POST / PUT / DELETE | CRUD de Autor |
| `/api/livros` | GET / POST / PUT / DELETE | CRUD de Livro |
| `/api/leitors` | GET / POST / PUT / DELETE | CRUD de Leitor |
| `/api/emprestimos` | GET / POST / PUT / DELETE | CRUD de Emprestimo |
